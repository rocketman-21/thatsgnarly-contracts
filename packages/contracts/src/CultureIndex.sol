    ...
    CultureIndexStorageV1
{
     ...
     * @param _gnarsToken The address of the Gnars Token contract
    ...
    function initialize(
        ...
        gnarsToken = IERC721Votes(_gnarsToken);
    ...
    function createPiece(
        ...
        if (gnarsToken.getVotes(msg.sender) < minVotingPowerToCreate) revert WEIGHT_TOO_LOW();
    ...
    function quorumVotes() public pure returns (uint256) {
        // modified to return 0 as quorum / drop sensitivity isn't as important for daily drops
        return 0;
    }
